...
if __name__ == "__main__":
    ...
    parser.add_argument('--plot', help='plot class distribution', default=False)
    ...
    print("avg fg/bg:",avg_fact)
    if args.plot:
        from matplotlib import pyplot as plt
        import numpy as np
        plt.hist(factors, bins=np.arange(0,0.25,0.001))
        plt.xticks(np.arange(0,0.25,0.001))
        plt.vlines(avg_fact, 0, 100, colors="r")
        plt.show()