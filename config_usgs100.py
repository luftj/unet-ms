...
path_osm = "/media/ecl2/DATA/jonas/usgs/osm/"
...
osm_url = "https://nc.hcu-hamburg.de/overpass_us/api/interpreter" # no trailing slash!
...
fill_polys = False
quadrangles_key = "blatt_100"#"CELL_NAME"